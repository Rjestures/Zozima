...
public class CollectionCategory extends BaseActivity implements View.OnClickListener {
    ...
    private void findViewById() {
        ...
        //Progresbar
        downprogresbar = findViewById(R.id.progresbar1);
...
*/
    ...
    private void getCatlogCollection() {
        ...
        try {
            ...
            jsonObject.put("collectionId", id);
            ...
            Log.v("getcollection", String.valueOf(json));
        ...
        AndroidNetworking.post(url)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        AppUtils.hideDialog();
                        Log.v("getcollection", String.valueOf(response));
                        try {
                            ...
                            if (jsonObject.getString("resCode").equals("1")) {
                                ...
                                downprogresbar.setVisibility(View.VISIBLE);
                                ...
                                downprogresbar.setVisibility(View.GONE);
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    private class CatalogueAdapter extends RecyclerView.Adapter<CatalogueHolder> {
        ...
        public CatalogueHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new CatalogueHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.inflate_catalogue, parent, false));
        }
    ...
    class DownloadFromURLShareNow extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            if (pos == 0) {
                ...
                mProgressDialog = new ProgressDialog(CollectionCategory.this);
...
//
    ...
    class DownloadFromURLlOther extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            if (other == 0) {
                // Create a progressdialog
                mProgressDialog1 = new ProgressDialog(CollectionCategory.this);
                // Set progressdialog title
                // Set progressdialog message
...
//                String file = String.valueOf( new File( file1, "name" + ".jpeg" ) );
    ...
    class DownloadFromURLDownloader extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            if (downlod == 0) {
                mProgressDialog2 = new ProgressDialog(CollectionCategory.this);
                // Set progressdialog title
